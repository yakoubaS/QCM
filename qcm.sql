...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : mar. 12 nov. 2024 à 15:42
...
(49, 'Quel est la couleur de cheveux de Zoro', 0),
(48, 'Quel est le gagnant du ballon dor 2023 ', 0),
(50, 'Quel est la prime de Luffy a la fin de de Wano', 1),
(51, 'Quel est le vainqueur de la ligue des champions 2013', 1),
(52, 'Quel joueur a marquÃ© 91 but sur une annÃ©e civil ', 1),
(54, 'Combien de porte GaÃ¯ peut-il ouvrir?', 1);
...
(160, 40, '42', 1),
(188, 50, '2,5 Milliard', 0),
(187, 50, '3 Milliard ', 1),
(184, 49, 'Bleu', 0),
(183, 49, 'Vert', 1),
(182, 48, 'Ronaldo la fraude', 0),
(186, 49, 'Rouge', 0),
(185, 49, 'Jaune', 0),
(181, 48, 'Haaland', 0),
(180, 48, 'Mbappe', 0),
(179, 48, 'Messi', 1),
(189, 50, '3,5 Milliard', 0),
(190, 50, '2,8 Milliard', 0),
(191, 51, 'Bayern ', 1),
(192, 51, 'Real', 0),
(193, 51, 'Barca', 0),
(194, 51, 'Chelsea', 0),
...
CREATE TABLE IF NOT EXISTS `resultats` (
  ...
  `idu` int(11) NOT NULL,
  `pseudo` varchar(50) CHARACTER SET utf8mb3 NOT NULL,
...
INSERT INTO `resultats` (`idqcm`, `idu`, `pseudo`, `note`) VALUES
(1, 88, 'test', 18),
(2, 1, 'Ã©leve', 8),
(6, 2, 'Ã©leve', 2),
(5, 2, 'Ã©leve', 2),
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `mdp` varchar(200) CHARACTER SET utf8mb4 NOT NULL,
...
(1, 'prof', 'prof', 'prof', 2),
(2, 'Ã©leve', 'eleve', 'eleve', 1),
(3, 'cool', 'cool', 'cool', 1),
(4, 'cool', 'cool', 'cool', 1),
(5, 'Antoine', 'Antoine', 'Antoine', 1),
(6, 'teste', 'testee', 'nonsah', 1);
COMMIT;
